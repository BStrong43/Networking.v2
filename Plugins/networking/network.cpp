...
int Network::initClient(char* IP, int port, char* username)
{
...
// Start Server.
int Network::initServer(int port, char* username, int maxClients)
{
...
int Network::sendOutBucks(data* boids, int length) {
...
int Network::intakeBucks(data* boids, int length)
{
	int len = sizeof(data) * length;
